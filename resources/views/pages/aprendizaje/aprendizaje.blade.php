...
<body class="w-100 h-screen bg-black fondo__pantalla">
    <div class="absolute">
        <canvas class="pointer-events-auto w-full h-full fixed top-0 left-0 z-50"></canvas>
    </div>
...
<script>
    const canvasOverlay = document.querySelector(".canvasOff");


    canvasOverlay.addEventListener("mouseenter", function() {
        // Desactivar temporalmente la animación del canvas
