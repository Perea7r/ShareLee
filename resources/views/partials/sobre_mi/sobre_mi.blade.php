        ...
        <div class="max-w-sm w-full lg:max-w-full lg:flex">
            <div class="flex-1 rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal"
                style="background-image: linear-gradient(to bottom, #4b006e, #0b0051);">
                <div class="">
                    ...
                    <p class="font-Montserrat text-lg">Tengo 28 años y soy de Sevilla, España. Fui cocinero y
                        ...
                        gran interés por el diseño. En 2021 comencé mi camino como desarrollador, enfocándome en
                        expandir
            ...
            <div class="flex-1 rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal"
                style="background-image: linear-gradient(to bottom, #FFB900, #FF773D);">
                <div class="">
                    <p class="text-sm flex items-center"></p>
                    <div class="font-Scifi text-black font-bold text-xl mb-2">¿Cúales son mis metas?</div>
                    <p class="font-Montserrat text-black text-lg">Mi objetivo es ser un todoterreno en el mundo del
                        desarrollo,
            ...
            <div class="flex-1 rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal"
                style="background-image: linear-gradient(to bottom, #00FFFF, #0080FF);">
                <div class="">
                    <p class="text-sm flex items-center"></p>
                    <div class="font-Scifi text-black font-bold text-xl mb-2">¡Conóceme un poco más!
                    </div>
                    <p class="font-Montserrat text-black text-lg">En mi tiempo libre me encanta jugar a videojuegos,
                        hacer deporte
